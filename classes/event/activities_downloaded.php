...
class activities_downloaded extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' downloaded activities for user '$this->relateduserid'";
    }
    ...
    public static function get_name() {
        return get_string('activitiesdownloaded', 'local_apprenticeoffjob');
    }
