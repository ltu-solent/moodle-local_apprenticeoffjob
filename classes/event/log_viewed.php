...
class log_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the log for '$this->relateduserid'.";
    }
    ...
    public static function get_name() {
        return get_string('logviewed', 'local_apprenticeoffjob');
    }
    ...
    public function get_url() {
        return new \moodle_url('/local/apprenticeoffjob/index.php', array());
    }
